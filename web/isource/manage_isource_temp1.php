...
//主页面
$contentModule = new lib_module('isource/source_temp1.module.php');
...
//加载当前页JS数据处理
$contentModule->addJavaScript('/manage_system/js/isource/source_temp1_handler.js');
$contentModule->addJavascriptCode($JSCode);

$content_views = array();

$contentModule->setView( $content_views );
$contentModule->addModule('searchBar', 'module/source/search_bar.module.php' , 'searchbar/source_temp1.php');
...
$contentModule->addModule('questionList' , 'module/source/question_list.module.php' , 'isource/question_list.php');
