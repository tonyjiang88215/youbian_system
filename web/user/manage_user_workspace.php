...
//主页面
$contentModule = new lib_module('user/manage_user_workspace.module.php');

//加载当前页JS数据处理
$contentModule->addJavaScript('/manage_system/js/user/manage_user_workspace_handler.js');
...
$contentModule->addModule('popPanels' , 'popup/user/popup_user_workspace.php' , 'popup/popup_user_workspace.php');
