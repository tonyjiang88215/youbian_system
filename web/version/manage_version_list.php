...
//主页面
$contentModule = new lib_module('base/base_curriculumn.module.php');
...
//加载当前页JS数据处理
$contentModule->addJavaScript('/manage_system/js/base/base_curriculumn_handler.js');
