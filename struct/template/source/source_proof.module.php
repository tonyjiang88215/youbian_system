...
<div class='content_main' >
	...
	<? $type=$_GET['type'] ? $_GET['type'] : 2; ?>
		<a class='content_tab <?=$type==1?'content_tab_select':''; ?>' href='?type=1' style='display:none;' ><span class='action_panel_label' >试卷</span></a>
	...
	<div class='content_element' style='min-height: 200px;'>
		<div class='content_tab_wrapper' style='display:none;'>
			<span class='content_tab <?=$_GET['type']==1?'content_tab_select':''; ?>' ><a class='action_panel_label' href='?mod=1&type=1'>试卷</a></span>
			<span class='content_tab <?=$_GET['type']==2?'content_tab_select':''; ?>' ><a class='action_panel_label' href='?mod=1&type=2'>同步</a></span>
			<span class='content_tab <?=$_GET['type']==3?'content_tab_select':''; ?>' ><a class='action_panel_label' href='?mod=1&type=3'>专题</a></span>
			<div class='clear_float'></div>
		</div>
