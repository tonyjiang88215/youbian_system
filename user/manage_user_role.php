...
//主页面
$contentModule = new lib_module('user/manage_user_role.module.php');

//加载当前页JS数据处理
$contentModule->addJavaScript('/manage_system/js/user/manage_user_role_handler.js');
...
$contentModule->addModule('pagerHTML' , 'module/source/pager_html.module.php' , array('pager'=>array('type'=>'js','totalcount'=>0,'offset'=>0,'step'=>10000,'linkMax'=>2)));
...
$contentModule->addModule('popPanels' , 'popup/user/popup_user_role.php' , 'popup/popup_user_role.php');
