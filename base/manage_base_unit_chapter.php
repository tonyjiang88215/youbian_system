...
//主页面
$contentModule = new lib_module('base/base_unit_chapter.module.php');

//加载当前页JS数据处理
$contentModule->addJavaScript('/manage_system/js/base/base_unit_chapter_handler.js');

$contentModule->addModule('searchBar', 'module/source/search_bar.module.php' , 'searchbar/base_unit_chapter.php');
$contentModule->addModule('treeHTML' , 'module/source/tree_html.module.php' , 'source/tree_data.php');

$popPanels =  new lib_module('popup/base/popup_unit_chapter.php');
$popPanels->addModule('search' , 'module/source/search_bar.module.php' , 'searchbar/popup_unit_chapter.php');
