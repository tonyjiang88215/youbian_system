...
//主页面
$contentModule = new lib_module('base/base_zhuanti.module.php');

//加载当前页JS数据处理
$contentModule->addJavaScript('/manage_system/js/base/base_zhuanti_handler.js');
...
$popPanels =  new lib_module('popup/base/popup_zhuanti.php');
